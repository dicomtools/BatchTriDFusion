function tDicomEntry = parseBatchDicomInfo(tinfo)
%function tDicomEntry = parseBatchDicomInfo(tinfo)
...
% along with BatchTriDFusion.  If not, see <http://www.gnu.org/licenses/>. 
    ...
    if isfield(tinfo, 'FrameOfReferenceUID')
        sFrameOfReferenceUID = tinfo.FrameOfReferenceUID;
    else
    ...
    tDicomEntry.FrameOfReferenceUID = sFrameOfReferenceUID;
